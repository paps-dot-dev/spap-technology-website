...
const DropdownExpansion: React.FC<Props> = ({ service }) => {
	return (
		<div className="lg:p-20">
			<img className="rounded-lg lg:mx-auto" src={service.thumbnail_path} />
			...
			<a
				href="/"
				className="flex justify-center items-center w-full mx-auto p-4 rounded-full bg-indigo-600 text-white my-4 text-sm font-semibold gap-2 cursor-pointer lg:p-8 lg:text-lg">
